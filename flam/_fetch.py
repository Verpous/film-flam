...
class Fetcher(abc.ABC):
    ...
    def _fetch(self, movie_list_file: _mlf.MovieListFile, refetch_re: None | re.Pattern, quiet: bool) -> None:
        ...
        if refetch_re is not None:
            ...
            _dbg.logger.info(f"Refetch pattern removed {nmovies_before - len(movie_list_file.movies_by_uid)} movies, {npeople_before - len(movie_list_file.people_by_uid)} people")
